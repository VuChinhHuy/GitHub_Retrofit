...
class RCVAdapterFollowing (private val context: Context, private val list : List<ListModelItem>) : RecyclerView.Adapter<RCVAdapterFollowing.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val userFollowing = list[position]
